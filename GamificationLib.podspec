...
Pod::Spec.new do |s|
  ...
  # s.resource  = "icon.png"
   s.resources = "GamificationLib/*.xcdatamodeld", "GamificationLib/PSAlertView.xib", "GamificationLib/AddActionAndPoints/AllActions.xib"
   s.preserve_paths = "GamificationLib/*.xcdatamodeld", "GamificationLib/PSAlertView.xib", "GamificationLib/AddActionAndPoints/AllActions.xib"
