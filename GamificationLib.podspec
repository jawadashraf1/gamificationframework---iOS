#
#  Be sure to run `pod spec lint GamificationLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/jawadashraf1/gamificationframework---iOS.git", :tag => "0.0.83" }
  ...
  # s.resource  = "icon.png"
   s.resources = "GamificationLib/GamificationLib_db.xcdatamodel","GamificationLib/GamificationLib_db.xcdatamodeld", "GamificationLib/PSAlertView.xib", "GamificationLib/AddActionAndPoints/AllActions.xib"
   s.preserve_paths = "GamificationLib/GamificationLib_db.xcdatamodel","GamificationLib/GamificationLib_db.xcdatamodeld", "GamificationLib/PSAlertView.xib", "GamificationLib/AddActionAndPoints/AllActions.xib"
  ...
  #s.dependency 'SVHTTPRequest','~> 0.5'
